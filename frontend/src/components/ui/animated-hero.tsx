...
interface ParticleHeroProps {
  ...
  children?: ReactNode;
  hideContent?: boolean; // Added so we can use just the background
}
...
export const ParticleHero: React.FC<ParticleHeroProps> = ({
  ...
  return (
    <section 
      className={`relative w-full min-h-[50vh] xl:min-h-screen bg-black overflow-hidden flex items-center justify-center ${className}`}
    ...
    >
        ...
        <div className="relative z-10 w-full flex flex-col items-center justify-center px-6 py-24">
          {children ? (
            ...
            <div className="text-center max-w-6xl mx-auto">
              {/* Main Title */}
              <div className="mb-12">
                <h1 className="text-8xl md:text-[10rem] lg:text-[12rem] xl:text-[14rem] font-black tracking-tighter leading-[0.8] mb-8">
              ...
              <div className="space-y-8">
                ...
                {/* Interactive hint */}
                {interactiveHint && (
                  <div className="flex items-center justify-center gap-6 text-red-400/40 text-sm uppercase tracking-[0.3em] pb-12">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden mix-blend-screen opacity-50">
        <div className="absolute top-20 left-20 w-80 h-80 bg-red-600/10 rounded-full blur-[100px] animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-orange-600/10 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
    </section>
  );
};
